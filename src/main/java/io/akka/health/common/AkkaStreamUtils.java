...
public class AkkaStreamUtils {
   ...
   */
  public static Source<StreamResponse, NotUsed> toAkkaSource(TokenStream tokenStream) {
    return
      Source
        .<StreamResponse>queue(10000)
        .mapMaterializedValue(queue -> {
          ...
          tokenStream
            ...
            .onPartialResponse(msg -> queue.offer(StreamResponse.partial(msg)))
